// Sudden expansion ER=3, structured/transfinite, symmetric about y=0.
  ...
  // --- transfinite ---
  nxi=10; nxe=40; nyi=6; nyo=10;
  Transfinite Curve{1,2,3}        = nxi Using Progression 0.96;
   // inlet x: refine at x=0
  Transfinite Curve{4,5,6,7,8}    = nxe Using Progression 1.03;
   // exp x: refine at x=0
  ...
  Physical Curve(11) = {17,18,19,20};      // outlet (x=20)
